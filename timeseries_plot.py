...
def plot_skab():
    ...
    fig = px.line(test_df, x = test_df.index, y = list(test_df.columns), width=1000, height=400, title=title)
...
def plot_msl(channel_name):
    ...
    title = 'Original Time Series Plot of MSL-C-1'    
    fig = px.line(test_df, x = test_df.index, y = list(test_df.columns), width=1000, height=400, title=title)
    #fig_json = fig.to_json()
    #fig.show()
...
def plot_smd(channel_name):
    ...
    title = 'Original Time Series Plot of SMD-1-1'    
    fig = px.line(test_df, x = test_df.index, y = list(test_df.columns), width=1000, height=400, title=title)
    #fig_json = fig.to_json()
    #fig.show()
