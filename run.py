...
def user_input():
    if request.method == "POST":
       ...
       try: 
           run_algorithm(dataset_name, algorithm_name)
           #print("skipping for debug")  
           ...
           print_on_flask = "Ran "+dataset_name+" on " + algorithm_name
           flash(print_on_flask)
           print(print_on_flask)
...
def results(dataset_name,algorithm_name):
    ...
    flash(ground_raw_predictions)
    flash(raw_predictions)
    
    header = "Visualization of Anomaly Detection Results"
    description = "Ran "+dataset_name+" on " + algorithm_name
...
def error(dataset_name,algorithm_name):
    ...
    header = "Error running "+dataset_name+" on " + algorithm_name
